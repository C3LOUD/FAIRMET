...
const SideBar = () => {
	...
	return (
		<Flex as="nav" direction="column" position="sticky" top="0" left="0" gap="1rem" minH="100vh">
			<Link to="/" reloadDocument>
				<Image src="/image/logo_italic.svg" alt="logo" h="5rem" py="1rem" px={2} />
			</Link>
			<Accordion defaultIndex={[0]}>
				<AccordionItem border="none" mb="1rem">
					...
					<AccordionPanel pb={4}>
						<VStack alignItems="start">
							...
							<SideBarItem direct="/#reference-search" text={'Reference Search'} />
				...
				<AccordionItem border="none" mb="1rem">
					...
					<AccordionPanel pb={4}>
						<VStack alignItems="start">
							<SideBarItem direct="/book/#all" text={'All \u3010Category\u3011'} />
							<SideBarItem direct="/book/#item" text={'Buy \uFF06 Pick \u3010ITEM\u3011'} />
							<SideBarItem direct="/book/#outfit" text={'Dress \uFF06 Wear \u3010OUTFIT\u3011'} />
							<SideBarItem
								direct="/book/#beauty"
